...
class InboundDocumento(Base):
    ...
    Baseline v1:
    - No guardamos binario en DB.
    - Guardamos metadata + uri/ruta del archivo.
    - Soft delete con activo (evita perder trazabilidad).
    """
    ...
    # metadata
    tipo = Column(String, nullable=False)          # "guia", "factura", "certificado", "foto", "otro"
    nombre = Column(String, nullable=False)        # nombre original (o friendly)
    ...
    creado_por = Column(String, nullable=True)     # email / usuario
